...
export default function WorkoutCard({ workout }: WorkoutCardProps) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-xl p-4 shadow-sm w-full text-left active:bg-gray-50 transition-colors cursor-pointer"
    >
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-gray-400 hover:text-red-600 active:text-red-700 p-1 -mr-1 min-w-[32px] min-h-[32px] flex items-center justify-center"
          >
            <svg
